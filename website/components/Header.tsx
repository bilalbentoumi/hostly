...
export function Header() {
  ...
  return (
    <nav className="fixed inset-x-0 top-0 z-[100] border-b border-line bg-[rgba(255,255,255,0.85)] backdrop-blur-[20px] dark:bg-[rgba(0,0,0,0.85)]">
      <div className="mx-auto flex h-14 max-w-wide items-center justify-between px-6">
        <a
          href="/"
